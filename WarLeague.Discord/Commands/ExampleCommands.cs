...
//        {
//            await RespondAsync("This command must be used in a server (guild).", ephemeral: false);
//            return;
//        }
...
//        if (guildUser == null)
//        {
//            await RespondAsync("Could not resolve guild user.", ephemeral: false);
//            return;
//        }
