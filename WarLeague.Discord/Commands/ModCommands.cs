...
//        {
//            await RespondAsync("Only administrators can close submissions.", ephemeral: false);
//            return;
//        }
...
//        if (!await _permissionService.IsAdminAsync(Context.User.Id))
//        {
//            await RespondAsync("Only administrators can check submissions.", ephemeral: false);
//            return;
//        }
...
//        if (!await _permissionService.IsAdminAsync(Context.User.Id))
//        {
//            await RespondAsync("Only administrators can view deck lists.", ephemeral: false);
//            return;
//        }
...
//        if (team == null)
//        {
//            await RespondAsync($"Team '{teamName}' not found.", ephemeral: false);
//            return;
//        }
...
//        if (!await _permissionService.IsAdminAsync(Context.User.Id))
//        {
//            await RespondAsync("Only administrators can make substitutions.", ephemeral: false);
//            return;
//        }
...
//        {
//            await RespondAsync("One or both players are not registered.", ephemeral: false);
//            return;
//        }
...
//        if (!await _permissionService.IsAdminAsync(Context.User.Id))
//        {
//            await RespondAsync("Only administrators can toggle captain actions.", ephemeral: false);
//            return;
//        }
...
//        if (!await _permissionService.IsAdminAsync(Context.User.Id))
//        {
//            await RespondAsync("Only administrators can post announcements.", ephemeral: false);
//            return;
//        }
...
//        {
//            await RespondAsync("Invalid channel.", ephemeral: false);
//            return;
//        }
...
//        await RespondAsync($"Announcement posted in {targetChannel.Mention}!", ephemeral: false);
//    }
//}
